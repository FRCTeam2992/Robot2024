...
public class Drivetrain extends SubsystemBase {
    ...
    public void moveRobotFrontBack(boolean forward, double velocity) {
        ...
        // Convert from m/s to speed percentage
        y1 = y1 / Constants.DrivetrainConstants.swerveMaxSpeed;
        ...
        frontLeft.setDriveVelocity(y1, 0);
        frontRight.setDriveVelocity(y1, 0);
        rearLeft.setDriveVelocity(y1, 0);
        rearRight.setDriveVelocity(y1, 0);
