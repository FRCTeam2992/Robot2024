 ...
 * is
 * at millisecond resolution. A "system timestamp", also at millisecond
 * resolution,
 * is also provided, which represents as accurately as possible the time at
 * which the
 * data was acquired from the navX-Model device. Note that the "system
 * timestamp"
...
public interface ITimestampedDataSubscriber {
    public void timestampedDataReceived(long system_timestamp, long sensor_timestamp, AHRSUpdateBase sensor_data,
            Object context);
}
