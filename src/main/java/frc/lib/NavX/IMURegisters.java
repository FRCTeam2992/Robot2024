...
public class IMURegisters {
	...
	/*
	 * Gyro Full-Scale Range (Degrees/Sec): Range: 250, 500, 1000 or 2000 [unsigned
	 * short]
	 */
	...
	/*
	 * Raw, Calibrated, Un-tilt corrected Magnetometer Data, in device units. 1 unit
	 * = 0.15 uTesla [signed short]
	 */
